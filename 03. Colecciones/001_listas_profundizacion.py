...
#fruits[8] = 'apple' Error index out of range

# Comprobacion de existencia, retorna boolean 
fruits = ['banana', 'orange', 'mango', 'lemon']
...
# Insertar elementos. Se indica la posicion
fruits = ['banana', 'orange', 'mango', 'lemon']
...
# Unir utilizando el metodo extend
num1 = [0, 1, 2, 3]
num2= [4, 5, 6]
num1.extend(num2)
...
# Ordenar una lista utiizando sort
# syntax
lst = ['item1', 'item2']
lst.sort()                # ascending
